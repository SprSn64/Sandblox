DIRS := src src/studio src/blockcode src/network src/softwarerender src/cjosn src/tempMaps
...
ifeq ($(OS),Windows_NT)
	TARGET := sandblox
	LDFLAGS := -lSDL3 -lSDL3_image -lgdi32 -lopengl32 -lglew32 -lws2_32 resource.res
else
